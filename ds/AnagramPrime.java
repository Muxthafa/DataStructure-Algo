...
public class AnagramPrime {
	...
	/**
	 * Checks if two prime numbers are anagram or not
	 * Anagram numbers are stored in anagram array
	 * nonanagram numbers are stored in nonanagram array
	 */
	...
	public static void main(String[] args) {
		AnagramPrime primeAnagram = new AnagramPrime();
